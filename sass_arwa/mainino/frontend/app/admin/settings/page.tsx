...
import { getAllInscriptions } from '@/lib/services/inscriptions';
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="text-lg font-bold text-gray-800 mb-2">Exporter les étudiants (CSV)</h3>
                                        <p className="text-sm text-gray-600 mb-4">
                                            Télécharger la liste complète des étudiants au format CSV pour Excel ou autres outils d'analyse.
                                        </p>
                                        <Button
