...
async function main() {
    ...
    const teachers = [
        {
            name: 'Ahmed Bennani',
            email: 'ahmed.bennani@injahi.com',
        ...
        {
            name: 'Fatima Alaoui',
            email: 'fatima.alaoui@injahi.com',
            password: await bcrypt.hash('teacher123', 10),
        ...
        {
            name: 'Mohammed Tazi',
            email: 'mohammed.tazi@injahi.com',
            password: await bcrypt.hash('teacher123', 10),
        ...
        },
        {
            ...
            email: 'amina.elkhattabi@injahi.com',
            password: await bcrypt.hash('teacher123', 10),
        ...
        },
        {
            ...
            email: 'youssef.bouazza@injahi.com',
            password: await bcrypt.hash('teacher123', 10),
    ...
    const groups = [
        {
            ...
            studentIds: [createdStudents[0].id, createdStudents[4].id], // Karim, Yassine
            timeSlots: [
        ...
        },
        {
            ...
            studentIds: [createdStudents[1].id, createdStudents[5].id], // Sara, Imane
            timeSlots: [
        ...
        },
        {
            ...
            room: 'Salle 103',
            status: 'Active',
            teacherId: createdTeachers[2].id, // Mohammed Tazi
            studentIds: [createdStudents[2].id, createdStudents[6].id], // Omar, Mehdi
            timeSlots: [
        ...
        },
        {
            ...
            room: 'Salle 104',
            status: 'Active',
            teacherId: createdTeachers[3].id, // Amina El Khattabi
            studentIds: [createdStudents[3].id, createdStudents[7].id], // Laila, Nour
            timeSlots: [
        ...
        },
        {
            ...
            room: 'Salle Lab Info',
            status: 'Active',
            teacherId: createdTeachers[4].id, // Youssef Bouazza
            studentIds: [createdStudents[4].id], // Yassine
            timeSlots: [
    ...
    const inscriptions = [
        {
            studentId: createdStudents[0].id, // Karim
            type: 'SOUTIEN',
        ...
        {
            studentId: createdStudents[1].id, // Sara
            type: 'SOUTIEN',
        ...
        {
            studentId: createdStudents[2].id, // Omar
            type: 'SOUTIEN',
        ...
        {
            studentId: createdStudents[3].id, // Laila
            type: 'SOUTIEN',
        ...
        {
            studentId: createdStudents[4].id, // Yassine
            type: 'FORMATION',
